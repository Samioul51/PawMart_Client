...
const Navbar = () => {
    ...
    return (
        <div className='flex flex-col items-center lg:justify-between lg:flex-row gap-[20px] lg:gap-0 py-[20px] box-border inter shadow-lg sticky top-0 z-50 bg-white'>
            <div>
                <NavLink to='/'>
